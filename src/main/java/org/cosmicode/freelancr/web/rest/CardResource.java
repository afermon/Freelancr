...
public class CardResource {
    ...
    @GetMapping("/cardsbyproject/{id}")
    @Timed
    public List<CardDTO> getCardsByProject(@PathVariable Long id) {

        return cardService.getByProject(id);
    }

    @GetMapping("/assigned")
    @Timed
    public Long getUnreadMessageCount(){
        return cardService.findAssignedCards();
    }
