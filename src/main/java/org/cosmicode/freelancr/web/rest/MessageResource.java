...
import org.cosmicode.freelancr.service.MessageService;
...
public class MessageResource {
    ...
    @GetMapping("/inbox")
    @Timed
    public ResponseEntity<List<MessageDTO>> getAllMessagesByReceiver(Pageable pageable) {
        Page<MessageDTO> page = messageService.findAllByReceiver(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/inbox");
        return new ResponseEntity<>(page.getContent(), headers, HttpStatus.OK);
    }
    ...
    @GetMapping("/msgCurrentUser")
    @Timed
    public List<MessageDTO> getAllMessageByReceiver() {
        return messageService.findAllByCurrentLogin();
    }

    @GetMapping("/msgSenderCurrentUser")
    @Timed
    public List<MessageDTO> getAllMessageBySender() {
        return messageService.findAllMessagesBySender();
    }
