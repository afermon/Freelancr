...
import org.cosmicode.freelancr.repository.CommentRepository;
import org.cosmicode.freelancr.repository.search.CommentSearchRepository;
import org.cosmicode.freelancr.service.dto.CommentDTO;
import org.cosmicode.freelancr.service.mapper.CommentMapper;
...
public class CommentService {
     ...
     */
    public List<CommentDTO> getAllCommentsByProject(Long id) {
        List<CommentDTO> comments = commentMapper.toDto(commentRepository.findByProjectId(id));
        return comments;
    }
}
