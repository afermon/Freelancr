...
@Component({
    selector: 'jhi-skill-freelancr',
    templateUrl: './skill-freelancr.component.html'
})
export class SkillFreelancrComponent implements OnInit, OnDestroy {
...
currentAccount: any;
        ...
        if (this.currentSearch) {
            this.skillService.search({
                ...
                sort: this.sort()}).subscribe(
                    (res: HttpResponse<SkillFreelancr[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/cms/skill-freelancr'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.currentSearch = '';
        this.router.navigate(['/cms/skill-freelancr', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: SkillFreelancr) {
        return item.id;
    }
