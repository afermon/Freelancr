...
describe('Service Tests', () => {
    ...
    describe('UserFreelancrFreelancr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UserFreelancrFreelancrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-freelancrs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserFreelancrFreelancr', () => {
