...
import { LanguageFreelancrDialogComponent } from '../../../../../../main/webapp/app/entities/language-freelancr/language-freelancr-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('LanguageFreelancr Management Dialog Component', () => {
        let comp: LanguageFreelancrDialogComponent;
        let fixture: ComponentFixture<LanguageFreelancrDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [LanguageFreelancrDialogComponent],
                providers: [
                    UserService,
                    LanguageFreelancrService
                ]
            })
            .overrideTemplate(LanguageFreelancrDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(LanguageFreelancrDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new LanguageFreelancr(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new LanguageFreelancr();
