...
describe('Service Tests', () => {
    ...
    describe('PositionFreelancr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PositionFreelancrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/positions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PositionFreelancr', () => {
