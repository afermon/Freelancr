...
describe('Service Tests', () => {
    ...
    describe('SkillTypeFreelancr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SkillTypeFreelancrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/skill-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SkillTypeFreelancr', () => {
