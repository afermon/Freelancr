...
describe('Service Tests', () => {
    ...
    describe('ApplicationMessageFreelancr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ApplicationMessageFreelancrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/application-messages';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ApplicationMessageFreelancr', () => {
