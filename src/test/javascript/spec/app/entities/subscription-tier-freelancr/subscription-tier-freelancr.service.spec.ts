...
describe('Service Tests', () => {
    ...
    describe('SubscriptionTierFreelancr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SubscriptionTierFreelancrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/subscription-tiers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SubscriptionTierFreelancr', () => {
