...
import {EMAIL_ALREADY_USED_TYPE, LOGIN_ALREADY_USED_TYPE, UserService} from '../../../../../../main/webapp/app/shared';
...
import { UserFreelancrFreelancrService } from '../../../../../../main/webapp/app/entities/user-freelancr-freelancr';
            ...
            inject([Register, JhiLanguageService],
                fakeAsync((service: Register, mockTranslate: MockLanguageService) => {
                    ...
                    expect(service.save).toHaveBeenCalledWith({
                        password: 'password',
                        langKey: 'en',
                        imageUrl: 'http://www.skywardimaging.com/wp-content/uploads/2015/11/default-user-image.png'
                    });
