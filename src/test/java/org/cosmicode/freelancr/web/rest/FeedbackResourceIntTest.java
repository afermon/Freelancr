...
public class FeedbackResourceIntTest {
    ...
    public void createFeedback() throws Exception {
        ...
        assertThat(testFeedback.getTimeStamp()).isEqualTo(DEFAULT_TIME_STAMP);
        ...
        assertThat(feedbackEs).isEqualToIgnoringGivenFields(testFeedback);
    }
    ...
    public void updateFeedback() throws Exception {
        ...
        Feedback testFeedback = feedbackList.get(feedbackList.size() - 1);
        assertThat(testFeedback.getTimeStamp()).isEqualTo(UPDATED_TIME_STAMP);
