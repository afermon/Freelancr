# Freelancr
Freelancr is an aplication that integrates with ElasticSeacrh, Paypal, Slack and Github. Developers can apply to or publish projects.
Once a project has been initiated, a new slack channel and github repository will be created for the project members. 
...
Circle CI v2 configuration files included
...
To optimize the freelancr application for production, run:
